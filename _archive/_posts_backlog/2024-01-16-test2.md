...
However, I suspect that not every healthcare provider group is or will ever become part of a "big health" entity.  The question still remains as to whether these non-big health entities can still serve the majority of patients that consume the most health care services (55+).

## Conclusion

This research helped me better understand the external forces driving the ever-increasing costs of healthcare in the US.  While I focused on one particular angle of the broader issues facing the industry, it was quite eye-opening to see how the US fared against its peer countries in terms of health outcomes and spend.  In addition, 
