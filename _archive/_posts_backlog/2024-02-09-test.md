...
Technology aside, there are still significant market forces, policies, and existing workflows that must be overcome.  As the JAMA report cites, more must be done at the policy level to address physician burnout.  Technology can help to some extent, but by how much still remains to be seen.  
