...
## Generative AI is having its moment with providers and patients
Some might say this moment in AI is the "perfect storm" - hospitals are struggling to rebound after the pandemic, most healthcare data is digitized, and computing has become powerful, cheaper, and smarter.  As noted in this recent piece in HBR, 

Dr. Galvin goes on to say that "CHAT GPT 4 and other large learning and generative models are truly revolutionary, but change in clinical medical is always evolutionary".  In one of his talks with Dr. David Blumenthal in 2020, the duo go on to highlight 
