...
One of the challenges I see with revolutionary technology in healthcare is that it may not significantly impact the 5% that Dr. Blumenthal mentions.  This [population](https://www.healthsystemtracker.org/chart-collection/health-expenditures-vary-across-population) is likely to be older with more health complications.  If we're interested in controlling  costs, its in this area that I think generative AI technology will face limitations.  In contrast, the 95% of patients who have everyday health concerns, will benefit from generative AI technologies, but may not move the needle very far when it comes to cost.    
