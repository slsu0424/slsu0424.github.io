...
"Healthcare loves a new new thing and generative AI is now it", stated Dr. Robert Galvin, an executive advisor of The Blackstone Group in this Forbes [piece](https://www.forbes.com/sites/sachinjain/2023/12/14/2024-healthcare-insiders-predict-the-future) predicting the top 2024 healthcare trends.  In following the recent announcements from VIVE to HIMSS , it was refreshing to see emerging technologies finally take center stage to great fanfare.  However, as much as new technology is revolutionary, healthcare has traditionally opposed it hand over fist.  The nature of our healthcare system is slow to change.  But in this unique time of technological progress, could healthcare become revolutionary, and should it be?

## Generative AI is having its moment, and we should be concerned
Some might say this moment in AI is the "perfect storm" - hospitals are struggling to rebound financially after the pandemic, there are increased worker shortages, most personal healthcare data is digitized, compute resources are cheaper, and algorithms are smarter.  
