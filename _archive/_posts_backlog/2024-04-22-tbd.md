...
There is no shortage of resources to learn about transformers such as the Generative Pre-trained Transformer (GPT).  I will not go into the details here, but provide links to blogs (additional resources also included in the reference section) that best illustrate key concepts.  
