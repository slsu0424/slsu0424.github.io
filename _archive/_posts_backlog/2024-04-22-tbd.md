...
In each of these examples, transformers appear to provide varying levels of utility, with perhaps the greatest potential for administrative tasks such as patient summarization and patient education.  I personally feel that clinical decision-making, or anything that involves human intuition, will never be replaced by a computer.

Yet I believe transformers can be a powerful aid for all healthcare stakeholders.  What excites me the most is an increased effort by clinicians, researchers, and informaticists to create new ideas and frameworks around these systems to improve patient care.  
