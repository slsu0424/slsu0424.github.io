...
In this January 2024 [study](https://www.nature.com/articles/s41746-024-01010-1#author-information), physicians at Stanford sought to use specialized instructional prompts that mimic the diagnostic reasoning criteria used by physicians.  The idea here was to address the "black box" critique of LLMs.  They compared this technique to [Chain-Of-Thought (CoT)](https://arxiv.org/abs/2201.11903) prompting to assess whether LLMs could exhibit clinical reasoning.  They found that LLMs can imitate clinical reasoning processes when using the specialized prompts, but still cannot reason like a human.  The authors conclude that the finding is still significant, in that it provides rationale which can be vetted for accuracy by physicians.
...
Another promising area of clinical application is in helping patients interpret their medical information.  As highlighted in this [paper](https://bmcmedinformdecismak.biomedcentral.com/articles/10.1186/s12911-024-02459-6#author-information), 
