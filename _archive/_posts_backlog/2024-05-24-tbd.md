...
## Conclusion
Throughout this recent journey in researching the societal effects of AI in healthcare, its become clear that we are navigating choppy waters with the novel technology.  As a technologist, we should not only care about bringing potentially life-changing solutions to market, but also consider its ethical implications and promote its safe use.  Its no wonder there has been heated debate between tech and the healthcare industry.  I remain optimistic that with consensus-built AI standards, we can work towards implementing technology that can improve health outcomes for all. 
