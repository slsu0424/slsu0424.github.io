...
Neural networks (generally) fall into the category of [generative models](https://www.turing.com/kb/generative-models-vs-discriminative-models-for-deep-learning), which can generate new data points similar to the data they were trained on.  Discriminative models separate data points into different classes and learn the boundaries.  

Admittedly, the concept of discriminative vs. generative models is a bit newer for me.  Lately, I've been reading 
...
On the other hand, discriminative models 
