...
Despite these limitations, I do agree with the authors that LLMs still have value in healthcare.  Perhaps it is better suited to situations where common medical conditions are seen and have a fairly standard treatment (i.e., primary care).  I can see how ChatGPT could allieve patient worries in this manner.  I still think that human intervention is required in more complex clinical cases, where having a correct diagnosis can mean life or death for a patient. 

This is not to say that humans aren't faultless, but I would argue that patients and their physicians establish a relationship where they are mutually working towards the best outcome.  This type of relationship does not exist between a human and a computer.
