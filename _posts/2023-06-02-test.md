...
Taking a step back and looking at the responses of ChatGPT vs. cardiologist, I thought about what responses would be more reassuring to me as a patient.  Let's think about this - if you ever find yourself in the emergency room, you know that physicians conduct a battery of tests before coming to a conclusion.  I don't necessarily think this is a bad thing, as the case illustrates above, as this is the hallmark of an expert diagnostician.  I can certainly appreciate the pre-mortem examination technique, as it forces one to think about the implications of a specific diagnosis and treatment plan.  As indicated above, if the patient was treated with medicines reserved for typical MI, but the patient had another confounding condition, the outcome may be fatal.  I wouldn't want my doctor to draw a conclusion based on what an AI system said, but that they would do a full workup before arriving at such.   
...
#### LLMs still have a place in healthcare

Currently, there are more focused LLMs trained on the medical domain that are currently under development, which is exciting.  Hopefully, these narrower models might serve to limit the hallucination tendencies that ChatGPT is currently prone to.

Despite these limitations, I do agree with the authors that LLMs still have value in healthcare.  Perhaps it is better suited to situations where common medical conditions are seen and have a fairly standard treatment (i.e., primary care).  I can see how ChatGPT could allay patient worries in this manner.  I still think that human intervention is required in more complex clinical cases, where having a correct diagnosis can mean life or death for a patient outcome. This is not to say that humans aren't faultless, but isn't that what makes medicine an art vs. science?
