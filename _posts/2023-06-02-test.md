...
Over the last few months, I have been following the tech news closely as new AI technologies, particularly Large Language Models ([LLMs])(https://en.wikipedia.org/wiki/Large_language_model) and [ChatGPT](https://en.wikipedia.org/wiki/ChatGPT), have exploded on to the scene.  Of course, being a bit skeptical, I was curious to see how this new iteration of technologies would fare in healthcare.  After pouring through endless news feeds of how the likes of ChatGPT were going to revolunitize healthcare, I felt I needed something to help ground in me in reality vs. hype.
