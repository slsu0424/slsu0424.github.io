...
Great, we have a well-performing system; ChatGPT is returning highly probabilistic results.  But herein lies the problem - just because we have a highly accurate AI system doesn't mean it translates well into clinical practice.  The article goes on to compare ChatGPT's answer to a cardiologist: 
