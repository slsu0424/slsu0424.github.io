...
#### A correct diagnosis matters in all cases
...
Despite these limitations, I agree with the authors that LLMs still have value in healthcare.  My key takeaways from this article:
* ChatGPT may be better suited to situations where common medical conditions are seen and have a standard treatment plan (i.e., primary care, outpatient).  If more common cases can be automated, this would free up time for more complex evaulations.
* Human review is required when any AI systems are involved.  But in complex clinical cases, employing human reasoning and intuition can mean life or death for a patient. 
