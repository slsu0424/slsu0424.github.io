...
I think this response is fine.  However, if a more accurate conclusion was made by human being, then what's the point of using this system if its going to add more minutes to a clinical workflow?
...
Lastly, I would argue that most physicians aim to establish a trust relationship with their patients, mutually working towards the best outcome.  This type of relationship does not exist between a human and a computer.
