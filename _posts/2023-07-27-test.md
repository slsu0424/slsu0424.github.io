...
We represent the unique words in a dictionary:
    
>{‘The’, ‘difference’, ‘between’, ‘actual’, ‘and’, ‘perceived’, ‘risk’, ‘levels’, ‘shows’, ‘distorted’, ...}
...
When we replace each word in document with these one-hot vectors, we start to get a pretty sparse space with a lot of zeroes!
