...
For NLP, one of the simplest techniques for encoding text is to represent each categorical variable (a word) as a binary vector.  The index of the word is marked with '1', and all other words are marked with '0'.
