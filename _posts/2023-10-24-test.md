...
According to LangChain, the [VectorstoreIndexCreator](https://api.python.langchain.com/en/latest/indexes/langchain.indexes.vectorstore.VectorstoreIndexCreator.html) class creates a vectorestore index from loaders.  By vectorstore index, this means 
