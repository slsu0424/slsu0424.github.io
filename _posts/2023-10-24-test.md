...
---
In September, I had the opportunity to present the 2nd iteration of my talk on LLMs.  This time I had a chance to go a bit deeper into the demos that covered integrating LLMs with LangChain, and LLMs with SQL.  I have written this tutorial to accompany the demos.    
...
LangChain has many different document loaders.  Very easily, we use **PyPDFLoader** to load in the PDF document and create a vector representation:
...
One area that was a little fuzzy to me and the audience was how the vectore store operates in LangChain.  According to LangChain, 
