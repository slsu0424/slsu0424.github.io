...
The VectorStoreIndexCreator handles steps 2-4 above (chunking, embedding, and storage).  This [article](https://medium.com/@kbdhunga/enhancing-conversational-ai-the-power-of-langchains-question-answer-framework-4974e1cab3cf) provides a bit more detail about the class, including customization.  Some default settings to note are: 
...
- Storage - embeddings are stored in the open-source vector store [Chroma](https://www.trychroma.com/)
