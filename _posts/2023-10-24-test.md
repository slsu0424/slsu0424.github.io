...
This 2 workflows help illustrate the steps above:
...
Fortunately, we can use LangChain to help us in developing this type of application.  [Langchain])https://docs.langchain.com/docs/) is a framework for developing applications powered by LLMs.  The main idea is that developers can "chain" different components around an LLM to create more powerful use cases.  
