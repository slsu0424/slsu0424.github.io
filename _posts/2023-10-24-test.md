...
Healthcare is inundated with data - much of it is in unstructured formats such as EHR notes, radiology images, medical device readings, and even consumer fitness wearables.  Focusing on the former, there is a wealth of knowledge buried in pages upon pages of written text.  While decades-old NLP techniques have been used to process and generate text, the ability to generate text with human-like accuracy is extremely [powerful](https://news.mit.edu/2023/ai-models-astrocytes-role-brain-0815).  

What if you could easily chat with data using natural language?  What if the engine could better understand your intent?
