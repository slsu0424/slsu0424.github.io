...
Fortunately, we can use [LangChain](https://docs.langchain.com/docs/) to help us in developing this type of application.  Langchain is a framework for developing applications powered by LLMs.  The main idea is that developers can "chain" different components around an LLM to create more powerful use cases.  
