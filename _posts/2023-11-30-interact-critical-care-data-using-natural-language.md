...
Download these MIMIC-III <a href="https://physionet.org/content/mimiciii-demo/1.4/" target="_blank">files</a> (open access), and load the [ADMISSIONS]() table into Azure SQL Database. 
