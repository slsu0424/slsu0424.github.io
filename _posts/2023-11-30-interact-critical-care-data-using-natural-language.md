...
*Note*: If planning to use [credentialed](https://mimic.mit.edu/docs/gettingstarted/) MIMIC data, it is recommended to enroll in the Azure OpenAI service - https://lnkd.in/eWcjS96R.
