...
However, I suspect that not every healthcare entity are or will ever become a "big health" entity.  The question remains as to whether these non-big health entities can still serve the majority of patients that consume the most health care services (55+).
