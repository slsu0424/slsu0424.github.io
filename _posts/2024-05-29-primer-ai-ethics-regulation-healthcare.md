...
To note, this should not be mistaken for AI-enabled devices that use other deep learning algorithms that have been recently approved by the FDA.  For example, the [Eko Low Ejection Fraction Tool](https://www.accessdata.fda.gov/scripts/cdrh/cfdocs/cfpmn/pmn.cfm?ID=K233409) was approved for cardiology use on March 24, 2024.  It makes use of deep neural network and convolutional neural network models for classification, per their [summary](https://www.accessdata.fda.gov/cdrh_docs/pdf23/K233409.pdf)
