...
---
After writing my last post, I was intrigued to learn a bit more about the black box phenomenon in AI models.  This is not to say that AI has not already been embedded into medical devices today, and the number of FDA-approved AI algorithms continues to increase.  However, I think it is important to understand the distinction of the algorithms built into such devices.  In this post, I aim to provide a technical lens on this topic.  
